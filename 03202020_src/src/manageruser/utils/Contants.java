...
public class Contants {
	...
	// define limit
	public static final int LIMIT_PAGE = Integer.parseInt(PagingProperties.getValueByKey("limit_page"));
	// set offset 
	...
	// MODE hiển thị sort
	public static final String MODE_SORT = "sort";
	// MODE hiển thị search
	public static final String MODE_SEARCH = "search";
	// MODE hiển thị search
	public static final String MODE_PAGING = "paging";
	// list sort 
